...
mutate(nval=n())  %>% 
  ...
  #filter(name!="Threat" & name!="CharismaticSpp" & name != "AlternativeLivelihood") %>%
  ...
  mutate("Topic_all" = case_when(Topic_all=="AdaptiveManagement" ~ "Adaptive Management",
                                 ...
                                 Topic_all=="ScientistEngagement" ~ "Scientist Engagement",
                                 Topic_all=="CharismaticSpp" ~ "Charismatic Species",
                                 #Topic_all=="AlternativeLivelihood" ~ "Alternative Livelihoods",
                                 str_detect(Topic_all,"oral")  ~ "Coral Reefs",
         .default=Topic_all),
         Topic_categories = case_when(Topic_all=="Mangrove" ~ "Ecosystems",
                                      ...
                                      str_detect(Topic_all,"harismatic") ~ "Species",
                                      
                                      str_detect(Topic_all,"hreats") ~ "Threats",
                                      
                                      str_detect(Topic_all,"esilience") ~ "Management Approaches",
                                      str_detect(Topic_all,"anagement") ~ "Management Approaches",
                                      Topic_all=="Seascape" ~ "Management Approaches",
                                      Topic_all=="Ridge to Reef" ~ "Management Approaches",
                                      
                                      str_detect(Topic_all,"ngagement") ~ "Engagement",
                                      
                                      str_detect(Topic_all,"ender") ~ "Engagement",
                                      str_detect(Topic_all,"ngage") ~ "Engagement",
                                      str_detect(Topic_all,"nowledge") ~ "Engagement",
                                      str_detect(Topic_all,"oluntourism") ~ "Engagement",
                                      str_detect(Topic_all,"iveli") ~ "Engagement",
                                      str_detect(Topic_all,"takeholder") ~ "Engagement",
...
mutate(nval=n())  %>% 
 ...
 # mutate(across(-c("Country","nval","Year_ManagementPlan"), ~./nval )) %>%
  ...
  arrange(Topic_categories,Topic_all) %>% 
  mutate(Topic_all=factor(Topic_all,levels=(unique(Topic_all)),ordered=TRUE))
```
