...
```
```{r}
wrap_plots(country.ecosystem.plot+labs(title=NULL)+theme(axis.text.x = element_text(angle=-45,vjust=0,hjust=0.1)),
           plot_spacer(),
...
#ggsave("/Users/lauragivens/Downloads/paperfocus.2.png",width=14,height=8,bg="white")
```
