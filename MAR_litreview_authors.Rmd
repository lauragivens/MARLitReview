...
ggsave("/Users/lauragivens/Downloads/roughdraft3check.png",width=20,height=12)
```
...
globe.mar <- full_join(globe,(year.countries.df %>% mutate(region=str_replace_all(value,"_"," "))))

ggplot() + geom_polygon(data=globe.mar,aes(x=long,y=lat,group=group,fill=total_percountry),color="black") + scale_fill_gradient(na.value = "lightgrey")
